10 REM PROGRAM NAME - THE JOURNEY TO THE WEST REVISED FROM OREGON        VERSION:02/15/21
...
240 PRINT "THIS PROGRAM SIMULATES THE JOURNEY TO THE WEST,"
250 PRINT "THE CHINESE NOVEL PUBLISHED IN THE 16TH CENTURY DURING THE MING DYNASTY."
260 PRINT "YOUR GROUP OF A MASTER AND THREE PRENTICES OF FOUR WILL TRAVEL HUNDRED THOUSAND MILES"
270 PRINT "IN SEARCH FOR HOLY SCRIPTURES."
280 PRINT
290 PRINT "YOU ARE GIVEN $700 AND THE HORSE BAILONG, "
300 PRINT "THE CURSED EASTERN-SEA DRAGON'S SON."
310 PRINT "YOU ARE ASKED TO PREPARE YOUR TRIP WITH"
320 PRINT 
330 PRINT " FOLLOWING ITEMS:"
340 PRINT "     MORE HORSE AND WAGON - BAILONG IS TRAVELING WITH YOU,"
350 PRINT "     BUT YOU TRAVEL FASTER IF YOU SPEND MORE ON HORSES,"
360 PRINT "     AND BAILONG MAY ALSO BEAR LESS BURDON."
370 PRINT
380 PRINT "     FOOD - THE MORE YOU HAVE, THE LESS CHANCE THERE IS OF GETTING SICK,"
390 PRINT "     BUT, REMEMBER, A GOOD BUDDHIST SHALL NOT ASK FOR MORE ONE NEEDS."
400 PRINT
410 PRINT "     ALMS BOWLS AND DHARMA- $1 BUYS 1 BOWL OR DHARMA THAT CAN BE USED FOR 50 TIMES"
420 PRINT "     YOU MUST USE ALMS BOWL AND YOUR DEVOTED BELIEF TO COLLECT ALMS."
430 PRINT "     THE DHARMA SHALL BE USED TO PRACTICE EXORCISM WHEN UNDER ATTACK."
440 PRINT
450 PRINT "     ROBES - THESE ARE NOT ONLY USEFUL IN THE COLD WEATHER"
460 PRINT "               BUT ALSO A SIGN OF DEVOTED BUDDHIST PRACTITIONER"
470 PRINT "               AND GOOD STYLES."
480 PRINT
490 PRINT "     ELIXIR AND JADE JAR - THESE ARE THE MAGIC MEDICINE AND TOOLS"
500 PRINT "              THAT WILL BE HELPFUL IN CASE OF ILLNESS"
510 PRINT "               AND EMERGENCY REPAIR"
520 PRINT
530 PRINT
...
570 PRINT "THE FORTS. YOU CAN ALSO COLLECT ALMS ALONG THE WAY TO GET"
580 PRINT "MORE FOOD."
590 PRINT "WHENEVER YOU HAVE TO USE YOUR ALMS BOWLS OR DHARMA ALONG THE WAY,"
600 PRINT "YOU WILL BE TOLD TO TYPE IN "AMITABHA","MERCY","WUKONG", OR "KINYA""
610 PRINT "TO PRAY. THE FASTER YOU TYPE IN THAT WORD AND HIT THE"
...
680 PRINT "GOOD LUCK!!!"
690 PRINT
700 PRINT "HOW DEVOTED ARE YOU AS A BUDDHIST PRACTITIONER? THE MORE DEVOTED YOU ARE,"
710 PRINT "THE EASIER TO COLLECT ALMS AND FIGHT MONSTERS WITH YOUR DHARMA."
720 PRINT "  (1) LIVING BUDDHA,  (2) DEDICATED ABBOT,  (3) STOIC BONZE,"
730 PRINT "  (4) APPRENTICE MONK ,  (5)  FLOWERY MONK(YOU FIND MONASTIC LIFE DREARY!)"
740 PRINT "ENTER ONE OF THE ABOVE -- THE BETTER YOU CLAIM YOU ARE, THE"
750 PRINT "FASTER YOU'LL HAVE TO BE WITH YOUR ALMS BOWL AND DHARMA TO BE SUCCESSFUL."
760 INPUT D9
...
830 PRINT
840 PRINT
850 PRINT "HOW MUCH DO YOU WANT TO SPEND ON YOUR HORSE TEAM";
860 INPUT A
...
970 GOTO 930
980 PRINT "HOW MUCH DO YOU WANT TO SPEND ON ALMS BOWLS AND DHARMAS";
990 INPUT B
1000 IF B >= 0 THEN 1030
1010 PRINT "IMPOSSIBLE"
1020 GOTO 980
1030 PRINT "HOW MUCH DO YOU WANT TO SPEND ON ROBES";
1040 INPUT C
1050 IF C >= 0 THEN 1080
1060 PRINT "IMPOSSIBLE"
1070 GOTO 1030
1080 PRINT "HOW MUCH DO YOU WANT TO SPEND ON ELIXIR AND JADE JAR";
1090 INPUT M1
...
1190 PRINT
1200 PRINT "LUNAR CALENDAR: MONDAY MARCH 29 639"
1210 PRINT
1220 GOTO 1750
...
1700 PRINT "YOUR GROUP DIES IN THE FIRST BLIZZARD OF WINTER"
1710 GOTO 5170
1720 PRINT "1847"
1730 PRINT
...
1840 PRINT "YOU'D BETTER PREACH	AND COLLECT ALMS OR BUY SOME FOOD SOON!!!!"
1850 F=INT(F)
1860 B=INT(B)
1870 C=INT(C)
1880 M1=INT(M1)
...
2041 PRINT "FOOD: ";F
2042 PRINT "BOWLS AND DHARMA: ";B
2043 PRINT "ROBES: ";C
2044 PRINT "ELIXIR AND JAR: ";M1
2050 PRINT "CASH: $";T
2060 IF X1=-1 THEN 2170
2070 X1=X1*(-1)
2080 PRINT "DO YOU WANT TO (1) STOP AT THE NEXT FORT, (2) COLLECT ALMS, ";
...
2150 LET X=3
2160 GOTO 2270
2170 PRINT "DO YOU WANT TO (1) COLLECT ALMS, OR (2) CONTINUE"
2180 INPUT X
...
2240 PRINT "TOUGH---YOU NEED MORE ALMS BOWLS AND DHARMAS"
2250 GOTO 2170
2260 X1=X1*(-1)
...
2400 RETURN
2410 F=F+2/3*P
2420 PRINT "ALMS BOWLS AND DHARMA";
2430 GOSUB 2330
2440 LET B=INT(B+2/3*P*50)
2450 PRINT "ROBES";
2460 GOSUB 2330
2470 C=C+2/3*P
2480 PRINT "ELIXIR AND JADE JAR";
2490 GOSUB 2330
2500 M1=M1+2/3*P
2510 M=M-45
2520 GOTO 2720
...
2550 PRINT "TOUGH---YOU NEED MORE ALMS BOWLS TO GO COLLECT ALMS"
2560 GOTO 2080
2570 M=M-45
2580 GOSUB 6140
...
2610 F=F+48-2*B1
2620 PRINT "AN ELDERLY COUPLE WISHES YOU GOOD LUCK AND BROUGHT WARM FOOD FOR YOU!!"
2630 B=B-10-3*B1
2640 GOTO 2720
2650 REM **BELLS IN LINE 2660**
2660 PRINT "FOUND A TEMPLE AND THE HOST WELCOMED YOU WITH A HEARTY MEAL!!!!"
2670 PRINT "FULL BELLIES TONIGHT!"
2680 F=F+52+RND(1)*6
2690 B=B-10-RND(1)*4
2700 GOTO 2720
2710 PRINT "THE FAMILY GOT A DEEPLY ATHEIST SON WHO CHASED YOU OUT OF THEIR HOUSE..."
...
3150 PRINT "SUN WUKONG(MONKEY) SWINGED HIS GOLDEN CUDGEL AND DROVE THEM OFF"
3160 GOTO 3470
3170 IF B1 <= 4 THEN 3220
3180 PRINT "ZHU(PIG) BAJIE GOT INJURED IN THE FIGHT."
3190 K8=1
3200 PRINT "YOU HAVE TO SEE GUANYIN FOR SOME CURE"
3210 GOTO 3470
...
3430 M=M-20
3440 GOTO 3470
3450 PRINT "MONSTERS DID NOT ATTACK"
3460 GOTO 3550
3470 IF S5=0 THEN 3500
3480 PRINT "MONSTER TURNS OUT TO BE FRIENDLY BUT MISCHIEVOUS. CHECK FOR POSSIBLE LOSSES"
3490 GOTO 3550
3500 PRINT "MONSTER WERE HOSTILE--CHECK FOR LOSES"
3510 IF B >= 0 THEN 3550
3520 PRINT "YOUR DHARMA WERE INSUFFICIENT AND GOT EATEN BY THE MONSTER"
3530 GOTO 5170
...
3680 LET M1=M1-8
3690 GOTO 4710
3700 PRINT "A HORSE INJURES LEG---SLOWS YOU DOWN REST OF TRIP"
3710 LET M=M-25
3720 LET A=A-20
3730 GOTO 4710
3740 PRINT "BACK LUCK---SHA WUJING(RIVER ORGE) BROKE HIS ARM"
3750 PRINT "YOU HAD TO STOP AND USE THE JADE JAR TO MAKE A SLING"
3760 M=M-5-4*RND(1)
3770 M1=M1-2-3*RND(1)
3780 GOTO 4710
3790 PRINT "A HORSE WANDERS OFF---SPEND TIME LOOKING FOR IT"
3800 M=M-17
3810 GOTO 4710
3820 PRINT "ZHU(PIG) BAJIE GETS LOST---SPEND HALF THE DAY LOOKING FOR HIM"
3830 M=M-10
3840 GOTO 4710
3850 PRINT "WUKONG AND YOU GOT IN A FIGHT AND RAN OFF, LOSE TIME CONVINCING HIM BACK"
3860 LET M=M-10*RND(1)-2
3870 GOTO 4710
3880 IF M>950 THEN 4490
3890 PRINT "THE THUNDER GOD PLAYED YOU WITH A HEAVY STORM---TIME AND SUPPLIES LOST"
3910 F=F-10
3920 B=B-500
3930 M1=M1-15
3940 M=M-10*RND(1)-5
3950 GOTO 4710
3960 PRINT "MONSTERS ATTACK"
3970 GOSUB 6140
3980 B=B-20*B1
3990 IF B >= 0 THEN 4030
4000 PRINT "YOUR DHARMA IS NOT SUFFICIENT---THE MONSTER STOLE YOUR CASH"
4010 T=T/3
4020 GOTO 4040
4030 IF B1 <= 1 THEN 4100
4040 PRINT "ZHU(PIG) BAJIE GOT HIT IN THE LEG AND THEY TOOK ONE OF YOUR HORSE"
4050 K8=1
4060 PRINT "BETTER HAVE BUDDHA OR GUANYIN TO LOOK AT YOUR WOUND"
4070 M1=M1-5
4080 A=A-20
4090 GOTO 4710
...
4370 PRINT "YOUR DHARMA ARE LOW ON MAGIC--"
4380 PRINT "THE WOLVES OVERPOWERED YOU"
4390 K8=1
4400 GOTO 5120
4410 IF B1>2 THEN 4440
4420 PRINT "NICE HIT WITH YOUR DHARMA---THEY DIDN'T GET MUCH"
4430 GOTO 4450
4440 PRINT "SLOW ON THE DRAW---THEY GOT AT YOUR FOOD AND ROBES"
4450 B=B-20*B1
4460 C=C-B1*4
4470 F=F-B1*8
4480 GOTO 4710
...
4510 PRINT "DONT'T ";
4520 C1=1
4530 PRINT "HAVE ENOUGH ROBES TO KEEP YOU WARM AND STYLISH"
...
4660 GOTO 4710
4670 PRINT "MERCIFUL VILLAGER SHOW YOU WHERE TO FIND MORE FOOD"
4680 F=F+14
4690 GOTO 4710
4700 REM ***MOUNTAINS***
...
4730 PRINT "FIERY MOUNTAINS"
4740 IF RND(1)>.1 THEN 4780
4750 PRINT "YOU GOT LOST---LOSE VALUABLE TIME TRYING TO CONNECT WITH BULL DEMON!"
4760 M=M-60
4770 GOTO 4860
...
5070 GOTO 5170
5080 LET T=0
5090 PRINT "NO GOD WOULD HELP YOU BECAUSE YOU DID'NT USE YOUR ALMS WELL"
5100 GOTO 5120
5110 PRINT "YOU RAN OUT OF ELIXIR"
...
5200 PRINT
5210 PRINT "WOULD YOU LIKE A SERVICE?"
5220 INPUT C$
...
5280 PRINT "BUT YOUR TEMPLE IS ENTRUSTS YOU AND HOPE TO HEAR FROM YOU"
5290 PRINT
5300 GOTO 5330
5310 PRINT "THAT WILL BE $4.50 FOR THE PIGEON MESSAGE CHARGE."
5320 PRINT
5330 PRINT "WE THANK YOU FOR THIS INFORMATION AND WE ARE SORRY YOU"
5340 PRINT "DIDN'T MAKE IT TO THE GREAT TERRITORY OF THE WEST"
5350 PRINT "BETTER LUCK NEXT TIME"
5360 PRINT
5370 PRINT
5380 PRINT TAB(30);"SINCERELY"
5390 PRINT
5400 PRINT TAB(17);"THE TEMPLE HOST"
...
5470 PRINT "YOU FINALLY ARRIVED THE WEST"
5480 PRINT "AFTER HUNDRED THOUSAND MILES---HOORAY!!!!!"
...
6041 PRINT "FOOD: ";F
6042 PRINT "BOWLS AND DHARAMA: ";B
6043 PRINT "ROBES: ";C
6044 PRINT "ELIXIR AND JAR: ";M1
6045 PRINT "CASH: ";T
6050 PRINT
6060 PRINT TAB(11); "TATHAGATA BUDDHA SENDS YOU HIS"
6070 PRINT TAB(17); "HEARTIEST CONGRATULATIONS"
6080 PRINT
6090 PRINT TAB(11);"AND WISHES YOU BE A PROSPEROUS BUDDHA"
6100 PRINT
6110 PRINT TAB(22);"AT HEAVENLY PALACE"
6119 REM 'STOP' COMMAND BELOW CHANGED TO 'END' BY C.D.P.
6120 END
6130 REM ***ALMS COLLECTING AND MONSTER FIGHTING SUB-ROUTINE***
6131 REM THE METHOD OF TIMING THE PRAYING (LINES 6210-6240)
...
6137 REM OR DECREASING THE 'PRAYING' TIME RECORDED BY THE SYSTEM
6140 DIM S$(5)
6150 S$(1)="AMITABHA"
6160 S$(2)="MERCY"
6170 S$(3)="WUKONG"
...
6207 REM B3 = TIMER CHANGED TO B3 = TIMER + 2 BY C.D.P. TO COLLECT ALMS...
6208 REM ...EASIER ON MODERN COMPUTERS. SEE NOTES FROM ORIGINAL AUTHOR ON
6209 REM ... ON TWEAKING ALMS COLLECTING DIFFICULTY
6210 B3 = TIMER + 2
6220 INPUT C$
...
6350 S4=1
6360 GOTO 6440
6370 PRINT "WILD ILLNESS---ELIXIR USED"
6380 M=M-5
6390 M1=M1-2
6400 GOTO 6440
6410 PRINT "BAD ILLNESS---ELIXIR USED"
6420 M=M-5
6430 M1=M1-5
...
6500 REM B1 = ACTUAL RESPONSE TIME FOR INPUTTING PRAYING WORDS
6510 REM B3 = CLOCK TIME AT START OF INPUTTING PRAYING WORDS
...
6580 REM D9 = CHOICE OF ALMS COLLECTING EXPERTISE LEVEL
...
6740 REM S6 = PRAYING WORD SELECTOR
6750 REM S$ = VARIATIONS OF PRAYING WORD
